...
import 'package:eshop/constants/global_variables.dart'; // Adjust import paths as needed
import 'package:eshop/features/admin/screens/bar_graph.dart'; // Adjust import paths as needed
...
class HomeBarGraph extends StatefulWidget {
  ...
  const HomeBarGraph({Key? key, required this.weeklyOrders, required this.totalWeeklyOrders ,required this.weeklyGrowth}) : super(key: key);
